...
import "./CreateRichTextCategory.css";
/**
 *
 * @returns
 */
const ConnectedCreateRichTextCategory = (props: any) => {
  ...
  const handleSubmit = (event: SyntheticEvent) => {
    event.preventDefault();
    let target = event.target as HTMLInputElement;
    props.onCreateRichTextCategory(state.name, state.icon, onDone);
  };
...
const CreateRichTextCategory = connect(
  mapStateToProps,
  mapDispatchToProps
)(ConnectedCreateRichTextCategory);

export default CreateRichTextCategory;
