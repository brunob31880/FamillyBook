...
import { AiFillEdit,AiOutlineTable, AiOutlineInsertRowBelow, AiOutlineInsertRowRight,AiOutlineDelete, AiFillTag, AiOutlineUpload, AiOutlineArrowsAlt, AiOutlineInsertRowAbove, AiOutlineInsertRowLeft,AiFillHtml5 ,AiFillCode,AiFillCodepenCircle} from 'react-icons/ai'
...
const iconList={
    ...
    code:<AiFillCode size={20}/>,
    insertCode:<AiFillCodepenCircle size={20}/>
}
